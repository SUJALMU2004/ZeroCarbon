  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-4xl items-center px-4 py-8 sm:px-6 sm:py-10 md:px-8">
      <section className="w-full rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm backdrop-blur-sm sm:p-8 md:p-12">
        ...
        <p className="mt-3 text-sm text-slate-500">Last updated: February 21, 2026.</p>
        <p className="mt-4 text-slate-600">
          This placeholder terms document defines platform usage conditions, account obligations, and
          marketplace participation requirements for ZeroCarbon users.
        </p>
      </section>
    </main>
  );
