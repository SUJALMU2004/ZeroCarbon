...
interface ProjectProofMapProps {
...
export default function ProjectProofMap({
  projectType,
  latitude,
  longitude,
  polygonGeojson,
}: ProjectProofMapProps) {
  ...
  if (!mapsApiKey) {
    return (
      <div className="flex h-44 items-center justify-center bg-red-50 text-sm text-red-700">
