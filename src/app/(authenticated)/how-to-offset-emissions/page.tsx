export default function HowToOffsetEmissionsPage() {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-4xl items-center px-4 py-8 sm:px-6 sm:py-10 md:px-8">
      <section className="w-full rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm backdrop-blur-sm sm:p-8 md:p-12">
        ...
        <p className="mt-3 text-slate-600">
          Start by estimating your emissions footprint, then select verified climate projects that
          align with your impact goals and region.
        </p>
        <p className="mt-3 text-slate-600">
          Purchase certified credits and retire them transparently so every offset is traceable and
          tied to real climate outcomes.
        </p>
      </section>
    </main>
  );
